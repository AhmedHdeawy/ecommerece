<?php
        ...
        function getAllFormTable($tblName, $orderBy, $where = null){

            $query = $where = null ? '' : $where;

            global $conn;
            $stmt = $conn->prepare("SELECT * FROM $tblName $query ORDER BY $orderBy DESC ");
            $stmt->execute();
            $count = $stmt->fetchAll();
            return $count;
        }
        ...
        function getItems($where, $value, $approve){
            ...
            $stmt = $conn->prepare("SELECT * FROM items WHERE $where = ? $query ORDER BY Item_ID ASC ");
        ...
        function getAllItems(){
            global $conn;
            $stmt = $conn->prepare("SELECT * FROM items  ORDER BY Item_ID ASC ");
            $stmt->execute();
            $count = $stmt->fetchAll();
            return $count;
        }
        ...
        // Function to check Whether this Username Activated or NO
